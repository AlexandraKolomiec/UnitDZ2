...
*/
     ...
     */
    @ParameterizedTest
    @ValueSource(chars = {'&', '#', '=','0', 'b'})

    public void incorrectProductSelectionCausesException(int i){
        char o= (char) i;
       // Act
        ...
        String actualMessage = "Не найден продукт с id: " + o;
        // Assert
        //assertThat(actualMessage).hasToString("Не найден продукт с id: " + o);
