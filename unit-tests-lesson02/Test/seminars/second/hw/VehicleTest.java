...
class VehicleTest {
    ...
    public void MotorcycleWith2Wheels(){
        Motorcycle motorcycle=new Motorcycle("Kawasaki ninja", "ZX 10R", 2021);
    ...
    public void MotorcycleSpeedTestDriveMode(){
        Motorcycle motorcycle1=new Motorcycle("Kawasaki ninja", "ZX 10R", 2021);
